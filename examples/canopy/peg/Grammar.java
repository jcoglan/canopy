...
abstract class Grammar {
            ...
            if (address1 != FAILURE) {
                ...
                if (address3 != FAILURE) {
                    ...
                    if (address4 != FAILURE) {
                        ...
                        TreeNode address10 = new TreeNode("", -1, new ArrayList<TreeNode>());
    ...
    TreeNode _read_grammar_name() {
        ...
        if (rule.containsKey(offset)) {
            ...
            String chunk0 = null;
            if (offset < inputSize) {
                chunk0 = input.substring(offset, Math.min(offset + 7, inputSize));
            }
        ...
        if (rule.containsKey(offset)) {
            ...
            if (address1 != FAILURE) {
                ...
                if (chunk0 != null && chunk0.equals("<-")) {
                    address3 = new TreeNode(input.substring(offset, offset + 2), offset, new ArrayList<TreeNode>());
                    offset = offset + 2;
                } else {
                    address3 = FAILURE;
                    if (offset > failure) {
            ...
            if (address1 != FAILURE) {
                ...
                if (address2 != FAILURE) {
                    ...
                    if (address4 != FAILURE) {
                        ...
                        int index3 = offset;
                        List<TreeNode> elements2 = new ArrayList<TreeNode>();
                        TreeNode address6 = new TreeNode("", -1, new ArrayList<TreeNode>());
                ...
                while (address3 != FAILURE) {
                    ...
                    if (address4 != FAILURE) {
                        ...
                        if (address6 != FAILURE) {
                            ...
                            int index5 = offset;
                            List<TreeNode> elements4 = new ArrayList<TreeNode>();
                            TreeNode address8 = new TreeNode("", -1, new ArrayList<TreeNode>());
