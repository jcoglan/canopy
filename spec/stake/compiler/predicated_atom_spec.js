Stake.Compiler.PredicatedAtomSpec = JS.Test.describe(Stake.Compiler.PredicatedAtom,
function() { with(this) {
  include(Stake.SpecHelper)
  
  describe('positive lookahead', function() { with(this) {
    before(function() { with(this) {
      Stake.compile('grammar AndTest\
  ...
  describe('negative lookahead', function() { with(this) {
    ...
    describe('combined with repetition', function() { with(this) {
      before(function() { with(this) {
        Stake.compile('grammar RepeatNotTest\
          predicate <- (!" " .)+ " "')
      }})
