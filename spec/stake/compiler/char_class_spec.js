Stake.Compiler.CharClassSpec = JS.Test.describe(Stake.Compiler.CharClass,
function() { with(this) {
  include(Stake.SpecHelper)
  
  describe('positive', function() { with(this) {
    before(function() { with(this) {
      Stake.compile('grammar PositiveCharClassTest\
        charClass <- [a-z]')
    }})
  ...
  describe('negative', function() { with(this) {
    before(function() { with(this) {
      Stake.compile('grammar NegativeCharClassTest\
        charClass <- [^a-z]')
    }})
