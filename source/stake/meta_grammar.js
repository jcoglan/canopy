...
(function(global) {;
    ...
    namespace = namespace.Stake = namespace.Stake || {};
})(this);

Stake.MetaGrammar = new JS.Module("Stake.MetaGrammar", {
    root: "grammar",
    __consume__grammar: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.Grammar instanceof Function) {
                ...
                klass5 = Stake.SyntaxNode;
            }
            address0 = new klass5(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.Grammar instanceof Function)) {
                address0.extend(Stake.Compiler.Grammar);
            }
    ...
    __consume__grammar_rule: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.GrammarRule instanceof Function) {
                ...
                klass0 = Stake.SyntaxNode;
            }
            address0 = new klass0(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.GrammarRule instanceof Function)) {
                address0.extend(Stake.Compiler.GrammarRule);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__choice_expression: function(input) {
        ...
        if (elements0) {
            ...
            address0 = new klass5(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.Choice instanceof Function)) {
                address0.extend(Stake.Compiler.Choice);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__choice_part: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.ChoicePart instanceof Function) {
                ...
                klass3 = Stake.SyntaxNode;
            }
            address0 = new klass3(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.ChoicePart instanceof Function)) {
                address0.extend(Stake.Compiler.ChoicePart);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__sequence_expression: function(input) {
        ...
        if (elements0) {
            ...
            address0 = new klass3(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.Sequence instanceof Function)) {
                address0.extend(Stake.Compiler.Sequence);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__sequence_part: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.SequencePart instanceof Function) {
                ...
                klass1 = Stake.SyntaxNode;
            }
            address0 = new klass1(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.SequencePart instanceof Function)) {
                address0.extend(Stake.Compiler.SequencePart);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__quantified_atom: function(input) {
        ...
        if (elements0) {
            ...
            address0 = new klass0(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.Repeat instanceof Function)) {
                address0.extend(Stake.Compiler.Repeat);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__predicated_atom: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.PredicatedAtom instanceof Function) {
                ...
                klass2 = Stake.SyntaxNode;
            }
            address0 = new klass2(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.PredicatedAtom instanceof Function)) {
                address0.extend(Stake.Compiler.PredicatedAtom);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__reference_expression: function(input) {
        ...
        if (elements0) {
            ...
            address0 = new klass1(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.Reference instanceof Function)) {
                address0.extend(Stake.Compiler.Reference);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__string_expression: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.String instanceof Function) {
                ...
                klass7 = Stake.SyntaxNode;
            }
            address0 = new klass7(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.String instanceof Function)) {
                address0.extend(Stake.Compiler.String);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
    ...
    __consume__any_char_expression: function(input) {
        ...
        if (this._input.substring(this._offset, this._offset + 1) === ".") {
            var klass0 = null;
            if (Stake.Compiler.AnyChar instanceof Function) {
                klass0 = Stake.Compiler.AnyChar;
            } else {
                klass0 = Stake.SyntaxNode;
            }
            address0 = new klass0(".", this._offset, [], {});
            if (!(Stake.Compiler.AnyChar instanceof Function)) {
                address0.extend(Stake.Compiler.AnyChar);
            }
            this._offset += 1;
        } else {
            address0 = null;
    ...
    __consume__char_class_expression: function(input) {
        ...
        if (elements0) {
            ...
            if (Stake.Compiler.CharClass instanceof Function) {
                ...
                klass9 = Stake.SyntaxNode;
            }
            address0 = new klass9(text0, this._offset, elements0, labelled0);
            if (!(Stake.Compiler.CharClass instanceof Function)) {
                address0.extend(Stake.Compiler.CharClass);
            }
            this._offset += text0.length;
        } else {
            address0 = null;
...
Stake.MetaGrammarParser = new JS.Class("Stake.MetaGrammarParser", {
    include: Stake.MetaGrammar,
