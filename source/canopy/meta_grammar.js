    ...
    __consume__grammar: function(input) {
        ...
        if (address1) {
            ...
            if (address3) {
                ...
                address3.__name__ = "grammar_name";
                ...
                while (address5) {
                    ...
                    if (address6) {
                        ...
                        if (address8) {
                            ...
                            address8.__name__ = "grammar_rule";
    ...
    __consume__grammar_name: function(input) {
        ...
        if (address1) {
            ...
            if (address2) {
                ...
                address2.__name__ = "object_identifier";
        ...
        if (address1) {
            ...
            if (address2) {
                ...
                if (address3) {
                    elements0.push(address3);
                    text0 += address3.textValue;
                    address3.__name__ = "parsing_expression";
        ...
        if (address1) {
            ...
            if (address2) {
                ...
                if (address4) {
                    elements0.push(address4);
                    text0 += address4.textValue;
                    address4.__name__ = "parsing_expression";
        ...
        if (address1) {
            ...
            if (address3) {
                ...
                if (address5) {
                    ...
                    address5.__name__ = "type_expression";
